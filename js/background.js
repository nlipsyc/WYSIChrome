...
>>>>>>> 83668c8c0c20de1036d6a26c995d5e25059b59da

	cssViewerLoaded = true;
});


function cssCiewerDebugParents( info, tab )
{
	chrome.tabs.executeScript(tab.id, {code:'cssViewerCopyCssToConsole("parents")'});
}
