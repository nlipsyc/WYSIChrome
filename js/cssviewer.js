...
{   
	function deepSelector(child){
		...
		var els = [];
		var cssPath = [];
		while (target && els.length < 7) { //Going 6 nodes up should be more than enough
			els.unshift(target);
	...
	if( 'parents' == type ) return console.log( "These are the parents", deepSelector(CSSViewer_element) );
